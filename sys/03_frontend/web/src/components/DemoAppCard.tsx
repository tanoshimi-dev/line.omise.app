  ...
  return (
    <div className="group relative rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
      ...
      <div className="p-6 sm:p-8">
        ...
        {/* External link to the live app (separate domain — dev-plan-08-frontend-lp) */}
        <a
          href={app.externalUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="mt-6 flex items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-sm font-semibold transition-colors hover:border-current"
          style={{ color: app.accentColor }}
        >
          デモサイトを見る
