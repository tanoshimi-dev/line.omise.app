...
export default function WhyUsSection() {
  return (
    <section id="why-us" className="py-20 sm:py-28 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {siteContent.whyUs.items.map((item, index) => (
            <div
              key={item.title}
              className="relative rounded-2xl bg-white p-8 shadow-sm hover:shadow-lg transition-all duration-300"
            >
              {/* Number badge */}
              <div className="absolute -top-4 left-8 flex h-8 w-8 items-center justify-center rounded-full bg-line-green text-white text-sm font-bold">
                {index + 1}
              </div>

              <div className="mb-4 mt-2 text-line-green">
                {icons[item.icon]}
              </div>
